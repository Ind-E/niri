...
enum Op {
    ...
    FocusWindowOrWorkspaceDownOrTop,
    FocusWindowOrWorkspaceUpOrBottom,
...
impl Op {
    fn apply(self, layout: &mut Layout<TestWindow>) {
        match self {
            ...
            Op::FocusWindowOrWorkspaceDownOrTop => layout.focus_window_or_workspace_down_or_top(),
            Op::FocusWindowOrWorkspaceUpOrBottom => layout.focus_window_or_workspace_up_or_bottom(),
            ...
            Op::FocusWorkspaceDownOrTop => layout.switch_workspace_down_or_top(),
            Op::FocusWorkspaceUpOrBottom => layout.switch_workspace_up_or_bottom(),
...
fn operations_dont_panic() {
    ...
    let every_op = [
        ...
        Op::FocusWorkspaceUp,
        Op::FocusWorkspaceDownOrTop,
        Op::FocusWorkspaceUpOrBottom,
        Op::FocusWorkspace(1),
        Op::FocusWorkspace(2),
