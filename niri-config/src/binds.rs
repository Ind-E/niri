...
impl From<niri_ipc::Action> for Action {
    fn from(value: niri_ipc::Action) -> Self {
        match value {
            ...
            niri_ipc::Action::FocusWindowOrWorkspaceDownOrTop {} => Self::FocusWindowOrWorkspaceDownOrTop,
            niri_ipc::Action::FocusWindowOrWorkspaceUpOrBottom {} => Self::FocusWindowOrWorkspaceUpOrBottom,
